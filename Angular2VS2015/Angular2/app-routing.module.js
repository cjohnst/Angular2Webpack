...
var routes = [
    ...
    { path: 'dir-highlight', component: dir_highlight_component_1.DirHighlightComponent },
    { path: 'service-webapi', component: service_webapi_component_1.ServiceWebAPIComponent }
];
